...
<template>
  ...
  >
    ...
    <el-table-column prop="operatedName" label="操作类型"></el-table-column>
    <el-table-column prop="resourceId" label="操作对象"></el-table-column>
    <el-table-column prop="joinResourceId" label="所属虚拟机"></el-table-column>
    <el-table-column prop="sourceIp" label="操作IP"></el-table-column>
    <el-table-column prop="date" label="操作时间" sortable="desc" />
    <el-table-column prop="status" label="操作状态" column-key="status">
