...
public class ResourceCountImpl implements IResourceCountService {
    ...
    public List<ResourceCountResponse> count(String accountId) {
        ...
        ResourceCountResponse vm = new ResourceCountResponse("xuniyunzhuji", LocaleUtil.getMessage("i18n.resource.vm", "云主机"), cloudServerService.count(vmQueryWrapper), "台");
        list.add(vm);
        ...
        ResourceCountResponse disk = new ResourceCountResponse("yuncunchu", LocaleUtil.getMessage("i18n.resource.disk", "磁盘"), cloudDiskService.count(diskQueryWrapper), "个");
        list.add(disk);
        ...
        ResourceCountResponse image = new ResourceCountResponse("jingxiang", LocaleUtil.getMessage("i18n.resource.image", "镜像"), cloudImageService.count(imageQueryWrapper), "个");
        list.add(image);
