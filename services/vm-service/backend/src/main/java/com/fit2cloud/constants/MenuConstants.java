    ...
    private static final Menus.Builder MENUS_BUILDER = new Menus.Builder()
            .menu(new Menu.Builder()
                    ...
                    .childMenu(new Menu.Builder()
                            ...
                            .icon("xuniji1")
                            .componentPath("/src/views/VmCloudServer/index.vue")
                            ...
                            .childOperationRoute(new Menu.Builder()
                                    ...
                                    .title("列表")
                                    .path("/list")
                                    .componentPath("/src/views/VmCloudServer/list.vue")
                                    .requiredPermission(new MenuPermission.Builder()
                                            .role(RoleConstants.ROLE.ADMIN)
                                            .permission(GROUP.CLOUD_SERVER, OPERATE.READ)
                                    )
                            ...
                            .childOperationRoute(new Menu.Builder()
                                    ...
                                    .title("详情")
                                    .path("/detail")
                                    .componentPath("/src/views/VmCloudServer/detail.vue")
                                    .requiredPermission(new MenuPermission.Builder()
                                            .role(RoleConstants.ROLE.ADMIN)
                                            .permission(GROUP.CLOUD_SERVER, OPERATE.READ)
                                    )
                    ...
                    .childMenu(new Menu.Builder()
                            ...
                            .path("/vm_cloud_disk")
                            .icon("yuncunchu")
                            .componentPath("/src/views/VmCloudDisk/index.vue")
                            ...
                            .childOperationRoute(new Menu.Builder()
                                    ...
                                    .title("磁盘列表")
                                    .path("/list")
                                    .componentPath("/src/views/VmCloudDisk/list.vue")
                                    .requiredPermission(new MenuPermission.Builder()
                                            .role(RoleConstants.ROLE.ADMIN)
                                            .permission(GROUP.CLOUD_DISK, OPERATE.READ)
                                    ...
                                    new Menu.Builder()
                                            ...
                                            .title("详情")
                                            .path("/detail")
                                            .componentPath("/src/views/VmCloudDisk/detail.vue")
                                            .requiredPermission(new MenuPermission.Builder()
                                                    .role(RoleConstants.ROLE.ADMIN)
                                                    .permission(GROUP.CLOUD_DISK, OPERATE.READ)
                                                    .permission(GROUP.CLOUD_DISK, OPERATE.EDIT)
                    ...
                    .childMenu(new Menu.Builder()
                            ...
                            .icon("jingxiang")
                            .componentPath("/src/views/VmCloudImage/index.vue")
                            ...
                            .childOperationRoute(new Menu.Builder()
                                    ...
                                    .title("镜像列表")
                                    .path("/list")
                                    .componentPath("/src/views/VmCloudImage/list.vue")
                                    .requiredPermission(new MenuPermission.Builder()
                                            .role(RoleConstants.ROLE.ADMIN)
                                            .permission(GROUP.CLOUD_IMAGE, OPERATE.READ)
                            ...
                            .childOperationRoute(
                                    new Menu.Builder()
                                            ...
                                            .title("详情")
                                            .path("/detail")
                                            .componentPath("/src/views/VmCloudImage/detail.vue")
                                            .requiredPermission(new MenuPermission.Builder()
                                                    .role(RoleConstants.ROLE.ADMIN)
                                                    .permission(GROUP.CLOUD_IMAGE, OPERATE.READ)
