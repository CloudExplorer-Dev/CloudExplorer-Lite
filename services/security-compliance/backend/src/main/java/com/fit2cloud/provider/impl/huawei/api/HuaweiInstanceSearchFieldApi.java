...
public class HuaweiInstanceSearchFieldApi {
    ...
    public static List<InstanceSearchField> listEcsInstanceSearchField() {
        InstanceSearchField status = new InstanceSearchField("云服务器状态", "status", InstanceFieldType.Enum,
                ...
                .resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.ECS);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.ECS, "tags");
    ...
    public static List<InstanceSearchField> listOssInstanceSearchField() {
        InstanceSearchField encryption = new InstanceSearchField("加密方式", "encryption.sseAlgorithm", InstanceFieldType.Enum,
                ...
                .resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.OSS);
    ...
    public static List<InstanceSearchField> listDiskInstanceSearchField() {
        InstanceSearchField status = new InstanceSearchField("云硬盘状态", "status", InstanceFieldType.Enum,
                ...
                )).resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.DISK);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.DISK, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.DISK, "tags");
    ...
    public static List<InstanceSearchField> listVpcInstanceSearchField() {
        ...
        InstanceSearchField cidr = new InstanceSearchField("私有云下可用子网的范围", "cidr", InstanceFieldType.String).resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.VPC);
        ...
        InstanceSearchField status = new InstanceSearchField("私有云下可用子网的范围", "cidr", InstanceFieldType.Enum,
                ...
                )).resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.VPC);
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.VPC, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.VPC, "tags");
    ...
    public static List<InstanceSearchField> listRamInstanceSearchField() {
        InstanceSearchField enabled = new InstanceSearchField("IAM用户是否启用", "enabled", InstanceFieldType.Enum,
                ...
                )).resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.RAM);
    ...
    public static List<InstanceSearchField> listRedisInstanceSearchField() {
        InstanceSearchField charging_mode = new InstanceSearchField("计费模式", "charging_mode", InstanceFieldType.Enum,
                ...
                .resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.REDIS);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.REDIS, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.REDIS, "tags");
    ...
    public static List<InstanceSearchField> listMongodbInstanceSearchField() {
        ...
        InstanceSearchField pay_mode = new InstanceSearchField("计费方式", "pay_mode", InstanceFieldType.Enum,
                List.of(new DefaultKeyValue<>("按需计费", "0"),
                        new DefaultKeyValue<>("包年/包月计费", "1")))
                .resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.MONGO_DB);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.MONGO_DB, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.MONGO_DB, "tags");
    ...
    public static List<InstanceSearchField> listRdsInstanceSearchField(ResourceTypeConstants resourceType) {
        InstanceSearchField status = new InstanceSearchField("实例状态", "status", InstanceFieldType.Enum,
                ...
                .resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, resourceType);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, resourceType, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, resourceType, "tags");
    ...
    public static List<InstanceSearchField> listElasticSearchInstanceSearchField() {
        ...
        InstanceSearchField status = new InstanceSearchField("实例状态", "status", InstanceFieldType.Enum,
                ...
                .resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.ELASTIC_SEARCH);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.ELASTIC_SEARCH, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.ELASTIC_SEARCH, "tags");
    ...
    public static List<InstanceSearchField> listLoadBalancerInstanceSearchField() {
        InstanceSearchField status = new InstanceSearchField("实例状态", "provisioning_status", InstanceFieldType.Enum,
                ...
                .resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.LOAD_BALANCER);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.LOAD_BALANCER, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.LOAD_BALANCER, "tags");
    ...
    public static List<InstanceSearchField> listPublicIpInstanceSearchField() {
        InstanceSearchField status = new InstanceSearchField("实例状态", "status", InstanceFieldType.Enum,
                ...
                .resetInstanceField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.PUBLIC_IP);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.PUBLIC_IP, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.PUBLIC_IP, "tags");
    ...
    public static List<InstanceSearchField> listSecurityGroupInstanceSearchField() {
        InstanceSearchField direction = new InstanceSearchField("安全组规则的出入控制方向", "direction", InstanceFieldType.NestedArrayEnum,
                ...
                .resetFilterArrayField(HuaweiCloudProvider.huaweiBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.SECURITY_GROUP, "group_rule");
