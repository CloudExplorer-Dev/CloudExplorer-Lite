...
public class TencentInstanceSearchFieldApi {
    ...
    public static List<InstanceSearchField> listEcsInstanceSearchField() {
        InstanceSearchField instanceChargeType = new InstanceSearchField("计费模式", "instanceChargeType", InstanceFieldType.Enum,
                ...
                )).resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.ECS);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.ECS, "tags");
    ...
    public static List<InstanceSearchField> listOSSInstanceSearchField() {
        InstanceSearchField refererStatus = new InstanceSearchField("是否开启防盗链", "referer.status", InstanceFieldType.Enum,
                ...
                .resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.OSS);
    ...
    public static List<InstanceSearchField> listDISKInstanceSearchField() {
        InstanceSearchField deleteWithInstance = new InstanceSearchField("云盘是否与挂载的实例一起销毁", "deleteWithInstance", InstanceFieldType.Enum,
                ...
                .resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.DISK);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.DISK, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.DISK, "tags");
    ...
    public static List<InstanceSearchField> listVpcInstanceSearchField() {
        InstanceSearchField isDefault = new InstanceSearchField("是否默认VPC", "isDefault", InstanceFieldType.Enum,
                List.of(new DefaultKeyValue<>("是", true),
                        new DefaultKeyValue<>("否", false)))
                .resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.VPC);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.VPC, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.VPC, "tags");
    ...
    public static List<InstanceSearchField> listPublicIpInstanceSearchField() {
        ...
        InstanceSearchField addressStatus = new InstanceSearchField("EIP状态", "addressStatus", InstanceFieldType.Enum,
                ...
                .resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.PUBLIC_IP);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.PUBLIC_IP, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.PUBLIC_IP, "tags");
    ...
    public static List<InstanceSearchField> listSecurityGroupInstanceSearchField() {
        InstanceSearchField isDefault = new InstanceSearchField("是否是默认安全组", "isDefault", InstanceFieldType.Enum,
                List.of(new DefaultKeyValue<>("是", true),
                        new DefaultKeyValue<>("否", false)))
                .resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.SECURITY_GROUP);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "key", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.SECURITY_GROUP, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "value", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.SECURITY_GROUP, "tags");
    ...
    public static List<InstanceSearchField> listMysqlInstanceSearchField() {
        InstanceSearchField wanStatus = new InstanceSearchField("外网状态", "wanStatus", InstanceFieldType.Enum,
                ...
                .resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.MYSQL);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "tagKey", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.MYSQL, "tags");
    ...
    public static List<InstanceSearchField> listSqlServerInstanceSearchField() {
        ...
        InstanceSearchField status = new InstanceSearchField("实例状态", "status", InstanceFieldType.Enum,
                ...
                )).resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.SQL_SERVER);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "tagKey", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.SQL_SERVER, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "tagValue", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.SQL_SERVER, "tags");
    ...
    public static List<InstanceSearchField> listMariadbInstanceSearchField() {
        InstanceSearchField status = new InstanceSearchField("实例状态", "status", InstanceFieldType.Enum,
                ...
                )).resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.MARIA_DB);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "tagKey", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.MARIA_DB, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "tagValue", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.MARIA_DB, "tags");
    ...
    public static List<InstanceSearchField> listPostgresInstanceSearchField() {
        ...
        InstanceSearchField status = new InstanceSearchField("实例状态", "dbinstanceStatus", InstanceFieldType.Enum,
                ...
                .resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.POST_GRE_SQL);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "tagKey", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.POST_GRE_SQL, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "tagValue", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.POST_GRE_SQL, "tags");
    ...
    public static List<InstanceSearchField> listRedisInstanceSearchField() {
        InstanceSearchField status = new InstanceSearchField("实例状态", "status", InstanceFieldType.Enum,
                ...
                .resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.REDIS);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "tagKey", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.REDIS, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "tagValue", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.REDIS, "tags");
    ...
    public static List<InstanceSearchField> listMongodbInstanceSearchField() {
        InstanceSearchField payMode = new InstanceSearchField("付费类型", "payMode", InstanceFieldType.Enum,
                ...
                .resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.MONGO_DB);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "tagKey", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.MONGO_DB, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "tagValue", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.MONGO_DB, "tags");
    ...
    public static List<InstanceSearchField> listElasticSearchInstanceSearchField() {
        InstanceSearchField status = new InstanceSearchField("实例状态", "status", InstanceFieldType.Enum,
                ...
                .resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.ELASTIC_SEARCH);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "tagKey", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.ELASTIC_SEARCH, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "tagValue", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.ELASTIC_SEARCH, "tags");
    ...
    public static List<InstanceSearchField> listLoadBalancerInstanceSearchField() {
        InstanceSearchField loadBalancerType = new InstanceSearchField("负载均衡实例的网络类型", "loadBalancerType", InstanceFieldType.Enum,
                ...
                .resetInstanceField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.LOAD_BALANCER);
        ...
        InstanceSearchField tagKey = new InstanceSearchField("标签键", "tagKey", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.LOAD_BALANCER, "tags");
        InstanceSearchField tagValue = new InstanceSearchField("标签值", "tagValue", InstanceFieldType.NestedArrayString)
                .resetFilterArrayField(TencentCloudProvider.tencentBaseCloudProvider.getCloudAccountMeta().platform, ResourceTypeConstants.LOAD_BALANCER, "tags");
