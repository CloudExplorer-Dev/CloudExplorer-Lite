...
public class ProxmoxBaseRequest {
     ...
     * 认证对象
     */
    private ProxmoxComplianceCredential credential;
    ...
    public ProxmoxComplianceCredential getCredential() {
        return credential;
    }

    public void setCredential(ProxmoxComplianceCredential credential) {
