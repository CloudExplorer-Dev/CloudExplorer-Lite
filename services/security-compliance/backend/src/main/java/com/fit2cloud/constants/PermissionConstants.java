...
public class PermissionConstants {
    ...
    private static final ModulePermission.Builder MODULE_PERMISSION_BUILDER = new ModulePermission.Builder().group()
            .group(new PermissionGroup.Builder().id(GROUP.OVERVIEW)
                    ...
                    .permission(new Permission.Builder().operate(OPERATE.CREATE)
                            .name("permission.security.overview.create")
                            .role(RoleConstants.ROLE.ADMIN))
                    .permission(new Permission.Builder().operate(OPERATE.EDIT)
                            .name("permission.security.overview.edit")
                            .role(RoleConstants.ROLE.ADMIN))
                    .permission(new Permission.Builder().operate(OPERATE.DELETE)
                            .name("permission.security.overview.delete")
                            .role(RoleConstants.ROLE.ADMIN))
            )
            .group(new PermissionGroup.Builder().id(GROUP.SCAN)
                    ...
                    .permission(new Permission.Builder()
                            ...
                            .name("permission.security.scan.create")
                            .role(RoleConstants.ROLE.ADMIN))
                    .permission(new Permission.Builder()
                            .operate(OPERATE.EDIT)
                            .name("permission.security.scan.edit")
                            .role(RoleConstants.ROLE.ADMIN))
                    .permission(new Permission.Builder()
                            .operate(OPERATE.DELETE)
                            .name("permission.security.scan.delete")
                            .role(RoleConstants.ROLE.ADMIN))
                    .permission(new Permission.Builder()
