    ...
    private static final Menus.Builder MENUS_BUILDER = new Menus.Builder()
            ...
            .menu(new Menu.Builder()
                    ...
                    .childMenu(new Menu.Builder()
                            ...
                            .componentPath("/src/views/optimize/index.vue")
                            .redirect("/resource_optimization/server_optimization/list")
                            .order(1)
                            .requiredPermission(new MenuPermission.Builder()
                                    .role(RoleConstants.ROLE.ADMIN)
                                    .permission(GROUP.SERVER_OPTIMIZATION, OPERATE.READ)
                            ...
                            .childOperationRoute(new Menu.Builder()
                                    .name("server_optimization_list")
                                    .path("/list")
                                    .saveRecent(true)
                                    .title("列表")
                                    .componentPath("/src/views/optimize/list.vue")
                                    .requiredPermission(new MenuPermission.Builder()
                                            .role(RoleConstants.ROLE.ADMIN)
                                            .permission(GROUP.SERVER_OPTIMIZATION, OPERATE.READ)
                                    )
                    ...
                    .childMenu(new Menu.Builder()
                            ...
                            .title("优化策略")
                            .path("/optimization_strategy")
                            .componentPath("/src/views/optimization_strategy/index.vue")
                            .redirect("/resource_optimization/optimization_strategy/list")
                            .order(2)
                            .requiredPermission(new MenuPermission.Builder()
                                    .role(RoleConstants.ROLE.ADMIN)
                                    .permission(GROUP.OPTIMIZATION_STRATEGY, OPERATE.READ)
                            ...
                            .childOperationRoute(new Menu.Builder()
                                    .name("optimization_strategy_list")
                                    .path("/list")
                                    .saveRecent(true)
                                    .title("列表")
                                    .componentPath("/src/views/optimization_strategy/list.vue")
                                    .requiredPermission(new MenuPermission.Builder()
                                            .role(RoleConstants.ROLE.ADMIN)
                                            .permission(GROUP.OPTIMIZATION_STRATEGY, OPERATE.READ)
                                    )
