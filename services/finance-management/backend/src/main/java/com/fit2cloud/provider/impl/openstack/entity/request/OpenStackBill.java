 ...
 */
@Data
public class OpenStackBill implements Bill {
    @Form(inputType = InputType.Radio, defaultValue = "api", execModule = "finance-management", textField = "key", valueField = "value", method = "getSyncModes", clazz = OpenstackBillProvider.class, attrs = "{\"style\":\"width:100%\"}")
