...
public class MenuConstants {
    ...
    private static final Menus.Builder MENUS_BUILDER = new Menus.Builder()
            .menu(new Menu.Builder().name("bill_view")
                    .title("账单总览")
                    .path("/bill_view")
                    ...
                    .order(1))
            .menu(new Menu.Builder().name("bill_detailed").title("账单明细")
                    .componentPath("/src/views/bill_detailed/index.vue")
                    .path("/bill_detailed")
                    .icon("yunzhuji2")
                    .requiredPermission(new MenuPermission.Builder()
                            .role(RoleConstants.ROLE.ADMIN)
                            .permission(GROUP.BILL_DETAILED, OPERATE.READ)).order(2))
            .menu(new Menu.Builder()
                    .name("custom_bill")
                    .title("自定义账单")
                    .componentPath("/src/views/custom_bill/index.vue")
                    .path("/custom_bill").icon("yunzhuji2")
                    .requiredPermission(new MenuPermission.Builder()
                            .role(RoleConstants.ROLE.ADMIN)
                            .permission(GROUP.CUSTOM_BILL, OPERATE.READ)).order(3))
            .menu(new Menu.Builder()
                    ...
                    .requiredPermission(new MenuPermission.Builder()
                            .role(RoleConstants.ROLE.ADMIN)
                            .permission(GROUP.DIMENSION_SETTING, OPERATE.READ)).order(4))
            //...
            ;
