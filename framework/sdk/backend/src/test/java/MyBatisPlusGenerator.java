...
public class MyBatisPlusGenerator {
     ...
     * 传入需要生成代码的表名
     */
    private static final List<String> TABLES = Arrays.asList("system_parameter");
    ...
    static {
        ...
        //指定需要生成enum的字段（Enum类需要自己生成）
        map.put("recycle_bin", convert(Arrays.asList(
                new EnumCreator().setEnumField("resource_type").setEnumClassName("ResourceTypeConstants").setEnumClass("com.fit2cloud.common.constants.ResourceTypeConstants"),
                new EnumCreator().setEnumField("status").setEnumClassName("RecycleBinStatusConstants").setEnumClass("com.fit2cloud.common.constants.RecycleBinStatusConstants")
        )));
    }
