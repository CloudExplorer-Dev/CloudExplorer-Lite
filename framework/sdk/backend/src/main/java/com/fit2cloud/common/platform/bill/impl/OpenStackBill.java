...
public class OpenStackBill implements Bill {
    @Form(inputType = InputType.Radio, defaultValue = "api", textField = "key", valueField = "value", method = "getSyncModes", clazz = OpenStackBaseCloudProvider.class, attrs = "{\"style\":\"width:100%\"}")
